...
import {
  ...
  makeBookingRow,
  makePaymentRow,
} from "./mechanic.fixtures";

export function metricReceipt(
  overrides: Partial<MetricReceipt> = {},
): MetricReceipt {
  return { ...makePaymentRow(), customer_id: CUSTOMER_ID, ...overrides };
}

export function metricRecord(
  overrides: Partial<BookingMetric> = {},
): BookingMetric {
  return {
    ...
    status: "completed",
    completedAt: new Date("2026-09-16T08:00:00Z"),
    payments: [],
    ...overrides,
  };
}
