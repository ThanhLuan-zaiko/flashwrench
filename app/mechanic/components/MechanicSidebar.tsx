...
// Sidebar owns navigation only. Visual language matches the admin sidebar:
// rounded links, zinc borders, monochrome active state.
                ...
                <li key={section.id}>
                  ...
                  >
                    ...
                    {!collapsed &&
                      ...
                      pendingCount > 0 && (
                        <span
                          title={`${pendingCount} đơn chờ nhận`}
                          aria-hidden="true"
