...
import { isUserTab, USER_TABS } from "./user-tabs";

// Mounted once by the /admin/users layout, so it survives tab switches
// between approve, lock, staff, trash and complaints. The tab comes from
// the URL on every navigation: dialog and filter state is reused, and the
// enter animation never replays for a mere tab switch.
