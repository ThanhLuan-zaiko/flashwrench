...
// Shared confirm dialog. Soft delete moves to trash (restorable); hard
// delete is permanent and requires typing the slug to unlock the button.
export function CatalogDeleteDialog({
  ...
  const kindLabel = target.kind === "category" ? "loại hình" : "mục giá";
